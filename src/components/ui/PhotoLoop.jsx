...
export default function PhotoLoop({ index, photos, bgColor,className }) {
  ...
  return (
    <div
      className={`relative rounded-3xl w-full lg:grow bg-white self-center flex items-center justify-center shadow-xl ${className} `}
    >
      {/* Top background circle */}
      <div
        className={`absolute -z-10 rounded-full h-24 w-24 md:h-28 md:w-28 lg:h-32 lg:w-32 ${
          index % 2 === 0
